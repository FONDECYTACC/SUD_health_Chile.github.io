...
paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","",path),"_mult_state_ags/five_st_msprep_jun.dta"))

rio::export(
d_match_surv_msprep %>% 
  rename_with(~ c("group.match","Readmission.status", "Readmission2.status", "Readmission3.status", "Readmission4.status",
      "Readmission.time", "Readmission2.time", "Readmission3.time", "Readmission4.time",  paste0("dias_treat_imp_sin_na_",1:4)), c("group_match", "Readmission_status", "Readmission2_status", "Readmission3_status", "Readmission4_status",
      "Readmission_time", "Readmission2_time", "Readmission3_time","Readmission4_time",
      "dias_treat_imp_sin_na_1", "dias_treat_imp_sin_na_2", "dias_treat_imp_sin_na_3", "dias_treat_imp_sin_na_4")) %>% 
      dplyr::select(
      ...
      tipo_de_plan_res_1,tipo_de_plan_res_2, tipo_de_plan_res_3, tipo_de_plan_res_4,
      days_treat_1, days_treat_2, days_treat_3, days_treat_4,
      TD_1, TD_2, TD_3, TD_4, DWCA_1, DWCA_2, DWCA_3, DWCA_4,
      ), 
  #dplyr::rename("id"="row", "ther_disch_time"="date_ther_disch","ther_disch_status"="ther_disch",
  #             "readmission_time"="date_post_treat","readmission_status"="readmission"),
paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","",path),"_mult_state_ags/five_st_msprep_jun.csv"))
```
