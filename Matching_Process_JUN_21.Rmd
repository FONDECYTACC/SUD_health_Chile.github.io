...
frailty_c<-
frailtypack::frailtyPenal(formula = Surv(Tstart,Tstop,status) ~ cluster(id) + tipo_de_plan_res_1+ TD_1+ TD_2 + TD_3+ TD_4, 
                          data = ms_d_match_surv,
                          RandDist="Gamma",
                          # "Gamma" for a gamma distribution, "LogN" for a log-normal distribution. Default is "Gamma".
...
cox_markov_test_prueba23d<-
  cox_markov_test(etm_ms_d_match_surv, formula="tipo_de_plan_res + TD_1 + TD2", tfrom=2 , tto=3, grid=tseq, trans=trans_matrix_etm, B=1000)
...
plot.MarkovTest(cox_markov_test_prueba24, tseq, what="states",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since arrival", ylab="Log-rank test statistic")

plot.MarkovTest(cox_markov_test_prueba34, tseq, what="states",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since arrival", ylab="Log-rank test statistic")

plot.MarkovTest(cox_markov_test_prueba57, tseq, what="states",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since arrival", ylab="Log-rank test statistic")

plot.MarkovTest(cox_markov_test_prueba67, tseq, what="states",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since arrival", ylab="Log-rank test statistic")

plot.MarkovTest(cox_markov_test_prueba810, tseq, what="states",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since arrival", ylab="Log-rank test statistic")

plot.MarkovTest(cox_markov_test_prueba910, tseq, what="states",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since arrival", ylab="Log-rank test statistic")
