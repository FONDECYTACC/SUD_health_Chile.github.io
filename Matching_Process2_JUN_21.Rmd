...
if(no_mostrar==1){
ggsave(paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","_mult_state_ags/",path),"Fig2_alt.jpg"), 
       fig_cox_abcd_lab, width = 11.5, height = 9, dpi = 600, units= "in")
ggsave(paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","_mult_state_ags/",path),"Fig2_alt.eps"), 
       fig_cox_abcd_lab, width = 11.5, height = 9, dpi = 600, units= "in")
ggsave(paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","_mult_state_ags/",path),"Fig2_alt.ps"),
       fig_cox_abcd_lab, width = 11.5, height = 9, dpi = 600, units= "in")
ggsave(paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","_mult_state_ags/",path),"Fig2_alt.pdf"),
       fig_cox_abcd_lab, width = 11.5, height = 9, dpi = 600, units= "in")
}
```
...
if(no_mostrar==1){
jpeg(paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","",path),"_mult_state_ags/pmatrix_probtrans_semimark_jun.jpg"), height=20, width= 10, res= 320, units = "in")
fig_ab_pmatrix
dev.off()
}
```
...
if(no_mostrar==1){
jpeg(paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","",path),"_mult_state_ags/lmaj_st_occ_ago_from1_3y.jpg"), height=8, width= 15, res= 320, units = "in")
lmaj_plot
dev.off()
}
```
