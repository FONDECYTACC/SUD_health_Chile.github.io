...
if (grepl("CISS Fondecyt",path)==T){
    setwd("C:/Users/CISS Fondecyt/Mi unidad/Alvacast/SISTRAT 2019 (github)/SUD_CL/");load("C:/Users/CISS Fondecyt/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_15_jun.RData")
  } else if (grepl("andre",path)==T){
    setwd('C:/Users/andre/Desktop/SUD_CL/');load("E:/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_15_jun.RData")
  } else if (grepl("E:",path)==T){
    setwd("E:/Mi unidad/Alvacast/SISTRAT 2019 (github)/SUD_CL/");load("E:/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_15_jun.RData")
  } else {
    setwd("G:/Mi unidad/Alvacast/SISTRAT 2019 (github)/SUD_CL/");load("G:/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_15_jun.RData")
  }
...
if (grepl("CISS Fondecyt",jpg_path)==T){
 ...
 if(no_mostrar==1){
jpeg(paste0(jpg_path,"_mult_state_ags/Cum_haz_markov_set_jun.jpg"), height=14, width= 12, res= 320, units = "in")
...
ggplot()+
  ...
  scale_linetype_manual(name= "Treatment\nsetting",values=c("dashed","solid"), labels=c("Outpatient","Residential"))+
...
p3 <- ggplot()+
  geom_step(data=msf0$Haz %>% dplyr::filter(trans==i), aes(time, Haz, linetype="dashed"),size=1, alpha=.65) + 
  geom_step(data=msf1$Haz %>% dplyr::filter(trans==i), aes(time, Haz, linetype="solid"),size=1, alpha=.65) + 
  scale_linetype_manual(name= "Treatment setting",values=c("dashed","solid"), labels=c("Outpatient","Residential"))+
...
if(no_mostrar==1){
ggsave(paste0(jpg_path,"Fig2_alt.jpg"), fig_cox_abcd_three_states_lab, width = 10, height = 11.5, dpi = 600, units= "in")
ggsave(paste0(jpg_path,"Fig2_alt.eps"), fig_cox_abcd_three_states_lab, width = 10, height = 11.5, dpi = 600, units= "in")
ggsave(paste0(jpg_path,"Fig2_alt.ps"), fig_cox_abcd_three_states_lab, width = 10, height = 11.5, dpi = 600, units= "in")
ggsave(paste0(jpg_path,"Fig2_alt.pdf"), fig_cox_abcd_three_states_lab, width = 10, height = 11.5, dpi = 600, units= "in")
}
```
...
if(no_mostrar==1){
jpeg(paste0(jpg_path,"_mult_state_ags/Cum_haz_ten_st_jun.jpg"), height=20, width= 10, res= 320, units = "in")
...
if(no_mostrar==1){
jpeg(paste0(gsub("SUD_CL/Matching_Process_APR_21.Rmd","",path),"_mult_state_ags/pmatrix_probtrans_semimark_jun.jpg"), height=20, width= 10, res= 320, units = "in")
fig_ab_pmatrix
dev.off()
}
```
...
rbind(cbind(pr="res",lmaj_res_1_1095,transo=1),
  ...
  #facet_wrap(state~., ncol=1, scales="free_y") + #type_of_program
  scale_fill_manual(name= "Type of\nprogram",values=c("gray35","gray75"), labels=c("Outpatient","Residential"))+
  scale_linetype_manual(name= "Type of\nprogram",values=c(1,4), labels=c("Outpatient","Residential")) +
  scale_x_continuous(breaks=seq(0,max(c(msf0$Haz$time,msf1$Haz$time),na.rm=T),by=max(c(msf0$Haz$time,msf1$Haz$time),na.rm=T)/11),
                     label=round(seq(0,max(c(msf0$Haz$time,msf1$Haz$time),na.rm=T),by=max(c(msf0$Haz$time,msf1$Haz$time),na.rm=T)/11)/365.25,2))+
  xlab("Years") + 
...
if(no_mostrar==1){
jpeg(paste0(gsub("SUD_CL/Matching_Process_APR_21.Rmd","",path),"_mult_state_ags/lmaj_st_occ_jun.jpg"), height=20, width= 10, res= 320, units = "in")
lmaj_plot
dev.off()
}
```
...
if(no_mostrar==1){
jpeg(paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","",path),"_mult_state_ags/probtrans_states_trans_jun2.jpg"), height=10, width= 15, res= 320, units = "in")
lmaj_ci_df_plot
dev.off()
}
```
...
if(no_mostrar==1){
jpeg(paste0(jpg_path,"_mult_state_ags/probtrans_states_trans_jun2.jpg"), height=10, width= 15, res= 320, units = "in")
lmaj_ci_df_plot2
dev.off()
}
...
if(no_mostrar==1){
jpeg(paste0(jpg_path,"_mult_state_ags/probtrans_states_jun.jpg"), height=10, width= 10, res= 320, units = "in")
fig_ab_pmatrix_probtrans
dev.off()
}
```
...
probtrans_df %>% 
 ...
 ggplot()+
    ...
    #facet_wrap(state~., ncol=1, scales="free_y") + #type_of_program
    scale_color_manual(name = "Exit\nState", values=c("gray30","gray70"), labels=c("Outpatient","Residential")) +
...
if(no_mostrar==1){
jpeg(paste0(gsub("SUD_CL/Matching_Process_APR_21.Rmd","",path),"_mult_state_ags/probtrans_states_trans_jun.jpg"), height=20, width= 10, res= 320, units = "in")
probtrans_df_plot
dev.off()
}
```
...
rbind.data.frame(cbind.data.frame(P12,at=0),
                 cbind.data.frame(P12_90,at=90),
                 cbind.data.frame(P12_365,at=365),
                 cbind.data.frame(P12_1096,at=1095)) %>% 
    dplyr::mutate(at=factor(at,levels = c(0,90,365,1095), labels=c("0 days","90 days", "1 year","3 years"))) %>% 
    #dplyr::mutate(l95ci=dplyr::case_when(se<.1 & Estimate==1~1,T~l95ci),
    #            u95ci=dplyr::case_when(se<.1 & Estimate==1~1,T~u95ci)) %>%
    ggplot(aes(time, P12))+#,² color= setting, linetype =setting, fill=setting
    geom_step(size=1, alpha=.65) + 
    geom_ribbon(aes(ymin=ll.band, ymax=ul.band), alpha=.5)+
    facet_wrap(~at, ncol=5, scales="free_y") + #
...
if (grepl("CISS Fondecyt",rstudioapi::getSourceEditorContext()$path)==T){
    save.image("C:/Users/CISS Fondecyt/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_2_jun.RData")
  } else if (grepl("andre",rstudioapi::getSourceEditorContext()$path)==T){
    save.image("C:/Users/andre/Desktop/SUD_CL/mult_state_2_jun.RData")
  } else if (grepl("E:",rstudioapi::getSourceEditorContext()$path)==T){
    save.image("E:/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_2_jun.RData")
  } else {
    save.image("G:/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_2_jun.RData")
  }
