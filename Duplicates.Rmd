...
```{r  Fig 5, warning=FALSE, fig.align = "center", message=F, out.width='0.75\\linewidth',cache=T}
knitr::include_graphics("G:/Mi unidad/Alvacast/SISTRAT 2019 (github)/SUD_CL/Figures/Figure_Duplicates.pdf")
```
```{r image-ref-for-in-text, echo=FALSE, fig.align='center', fig.cap='Some cool caption', fig.pos='H', message=FALSE, out.width='0.75\\linewidth'}
knitr::include_graphics("G:/Mi unidad/Alvacast/SISTRAT 2019 (github)/SUD_CL/Figures/Figure_Duplicates.pdf")
```
