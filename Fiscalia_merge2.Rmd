...
Base_fiscalia_v3 %>% 
    ...
    dplyr::select(rut_enc_saf,gls_tipo_sujeto_vic,fec_nacimiento_simple,fec_comision_simple, gls_parentesco, termino_relacion_simple,fech_nac, edad_al_ing, edad_ini_cons,contains("rpa"), obs) %>% 
