...
flow_fech_nac_fisc_vs_senda <- 
  ...
  #years_crime_po years_crime_po2nd years_crime_senda
  dplyr::mutate(c_22_1_a0a= dplyr::case_when(is.na(diff)~1,T~0)) %>%
  dplyr::mutate(c_22_1_a0c= dplyr::case_when(diff<90~1,T~0)) %>% 
  dplyr::mutate(c_22_1_a= dplyr::case_when(nchar(obs)>1~1,T~0)) %>%  
  #dplyr::mutate(c_22_1_a_12_ab= dplyr::case_when(encontrado_como_imputado=="SI"~1,T~0)) #%>%
  dplyr::mutate(c_22_1_a_12_ab= dplyr::case_when(n_imputed>0~1,T~0)) %>% 
  dplyr::mutate(c_22_1_a1a_12_a= dplyr::case_when(years_crime_po<14~1,T~0)) %>% 
  dplyr::mutate(c_22_1_a1a_12_b= dplyr::case_when(years_crime_senda<14~1,T~0)) %>% 
  dplyr::mutate(c_22_1_a1a1a= dplyr::case_when(years_crime_po2nd<14~1,T~0)) 
...
paste0("Paired w/ discrepancies \n(22_1_a)\n(n= ",format(nrow(fech_nac_fisc_vs_senda2),big.mark=","),";\n",
...
paste0("Invalid dates\n(n= ",format(as.numeric(table(is.na(fech_nac_fisc_vs_senda2$diff))[2]),big.mark=","),";\n",scales::percent(as.numeric(table(is.na(fech_nac_fisc_vs_senda2$diff))[2])/length(unique(Base_fiscalia_v3$rut_enc_saf))),"; ",scales::percent(as.numeric(table(is.na(fech_nac_fisc_vs_senda2$diff))[2])/length(unique(CONS_C1_df_dup_SEP_2020$hash_key))),")")

paste0("22_1_a0c\n(n= ",format(as.numeric(table(flow_fech_nac_fisc_vs_senda$c_22_1_a0c)[2]),big.mark=","),";\n",scales::percent(as.numeric(table(flow_fech_nac_fisc_vs_senda$c_22_1_a0c)[2])/length(unique(Base_fiscalia_v3$rut_enc_saf))),"; ",scales::percent(as.numeric(table(flow_fech_nac_fisc_vs_senda$c_22_1_a0c)[2])/length(unique(CONS_C1_df_dup_SEP_2020$hash_key))),")")
paste0("Differences above 90d_22_1_a0d\n(n= ",format(as.numeric(table(flow_fech_nac_fisc_vs_senda$c_22_1_a0c)[1]),big.mark=","),";\n",scales::percent(as.numeric(table(flow_fech_nac_fisc_vs_senda$c_22_1_a0c)[1])/length(unique(Base_fiscalia_v3$rut_enc_saf))),"; ",scales::percent(as.numeric(table(flow_fech_nac_fisc_vs_senda$c_22_1_a0c)[1])/length(unique(CONS_C1_df_dup_SEP_2020$hash_key))),")")
...
paste0("(22_1_a1)\n(n= ", flow_fech_nac_fisc_vs_senda %>% dplyr::filter(c_22_1_a==1) %>% nrow(),";\n", scales::percent(flow_fech_nac_fisc_vs_senda %>% dplyr::filter(c_22_1_a==1) %>% nrow()/length(unique(Base_fiscalia_v3$rut_enc_saf)), accuracy=0.1),"; ",
       scales::percent(flow_fech_nac_fisc_vs_senda %>% dplyr::filter(c_22_1_a==1) %>% nrow()/length(unique(CONS_C1_df_dup_SEP_2020$hash_key)), accuracy=0.1),")")


paste0("(22_1_a1)\n(n= ", flow_fech_nac_fisc_vs_senda %>% dplyr::filter(c_22_1_a0c==0, c_22_1_a==1) %>% nrow(),";\n", scales::percent(flow_fech_nac_fisc_vs_senda %>% dplyr::filter(c_22_1_a0c==0,c_22_1_a==1) %>% nrow()/length(unique(Base_fiscalia_v3$rut_enc_saf)), accuracy=0.1),"; ",
       scales::percent(flow_fech_nac_fisc_vs_senda %>% dplyr::filter(c_22_1_a0c==0, c_22_1_a==1) %>% nrow()/length(unique(CONS_C1_df_dup_SEP_2020$hash_key)), accuracy=0.1),")")
