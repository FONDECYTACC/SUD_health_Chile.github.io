...
```{r fig0noincluido, echo=T, fig.align='center', message=T, fig.caption="Figure 1.Summary of Process of Data Cleaning and Standardization, Imputation & Matching", fig.height=10, error=T, eval=T, dpi=320}
...
```{r fig1, fig.align='center', fig.pos='H', fig.capn="Date of birth", echo=T, cache= T, paged.print=TRUE, eval=T, error=T, dpi=320, fig.align="center", out.height= "4.5in", out.width="100%"}
plot_dob<-
Base_fiscalia_v2  %>% 
...
```{r pas0erasecasesafterfollowup, echo=T, cache= T, paged.print=TRUE, eval=T, error=T, dpi=320, fig.align="center"}
...
```{r paso-1-dates, fig.align='center', fig.cap="Absolute differences between SENDA and POs date of birth", echo=T, cache= T, paged.print=TRUE, eval=T, error=T, dpi=320, fig.align="center"}
...
## Explore Results of the Preliminary Matching{.tabset .tabset-fade}
