...
```{r fig9b_int_changes_referral,eval=T, echo=T, paged.print=TRUE,fig.cap= "Figure 9. Interactive Effects on Odds of having <=60 days of difference with the previous entry"}
library(lsmeans)
