...
sel_param_fits <- vector(length = n_trans, mode = "list") 
    ...
    sel_param_fits[[3]]<- fits_c_llogis[[3]]
...
# Gen-gamma, Gen-gamma, Gen-gamma, Log-logistic, Lognormal
# Gen-gamma, Gen-gamma, Gen-gamma, Log-logistic, Gen-gamma
# Gen-gamma, Gen-gamma, Gen-gamma, Gen-gamma, Lognormal
# Gen-gamma, Gen-gamma, Gen-gamma, Gen-gamma, Gen-gamma
...
# Lognormal, Gompertz, Gen-gamma, Log-logistic, Lognormal
# Lognormal, Gompertz, Gen-gamma, Log-logistic, Gen-gamma
# Lognormal, Gompertz, Gen-gamma, Gen-gamma, Lognormal
# Lognormal, Gompertz, Gen-gamma, Gen-gamma, Gen-gamma
...
# Lognormal, Gen-gamma, Gen-gamma, Log-logistic, Lognormal
# Lognormal, Gen-gamma, Gen-gamma, Log-logistic, Gen-gamma
# Lognormal, Gen-gamma, Gen-gamma, Gen-gamma, Lognormal
# Lognormal, Gen-gamma, Gen-gamma, Gen-gamma, Gen-gamma
...
sel_param_fits_4s <- vector(length = n_trans2, mode = "list") 
    sel_param_fits_4s[[1]]<- fits_c_ggam2[[1]]
    sel_param_fits_4s[[2]]<- fits_c_gomp2[[2]]
    sel_param_fits_4s[[3]]<- fits_c_ggam2[[3]]
    sel_param_fits_4s[[4]]<- fits_c_llogis2[[4]]
    sel_param_fits_4s[[5]]<- fits_c_logn2[[5]]
