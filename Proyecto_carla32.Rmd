...
par(mfrow = c(2, 2))
plot(msf0, cols = rep(1, 3), lwd = 2, lty = 1:3, xlab = "Years after admission",#xlim=c(0,12),ylim=c(0,.6),
 ylab = "Baseline hazards for each transition", legend.pos = c(4, .15), main= "General Population")
 plot(msf1, cols = rep(1, 3), lwd = 2, lty = 1:3, xlab = "Years after admission",# xlim=c(0,12),ylim=c(0,.6),
 ylab = "", legend.pos = c(4, .15), main= "Women Especific")
 plot(msf0_4s, cols = rep(1, 5), lwd = 2, lty = 1:5, xlab = "Years since in the state",#xlim=c(0,12),ylim=c(0,.6),
 ylab = "Baseline hazards for each transition", legend.pos = "bottom", main= "General Population")
 plot(msf1_4s, cols = rep(1, 5), lwd = 2, lty = 1:5, xlab = "Years after baseline",# xlim=c(0,12),ylim=c(0,.6),
 ylab = "", legend.pos = c(4, .85), main= "Women Especific")

if(no_mostrar==1){
jpeg("C:/Users/andre/Desktop/SUD_CL/eso14.jpg", height=14, width= 12, res= 96, units = "in")
  
par(mfrow = c(2, 2))
plot(msf0, cols = rep(1, 3), lwd = 2, lty = 1:3, xlab = "Years after admission",ylim=c(0,1.2),xlim=c(0,12),
 ylab = "Baseline hazards for each transition", legend.pos = c(4, 1.15), main= "General Population")
 plot(msf1, cols = rep(1, 3), lwd = 2, lty = 1:3, xlab = "Years after admission", ylim=c(0,1.2),xlim=c(0,12),
 ylab = "", legend.pos = c(4, 1.15), main= "Women Especific")
 plot(msf0_4s, cols = rep(1, 5), lwd = 2, lty = 1:5, xlab = "Years since in the state",ylim=c(0,1.2),xlim=c(0,12),
 ylab = "Baseline hazards for each transition", legend.pos =c(4, .85), main= "General Population",cex = 0.5)
 plot(msf1_4s, cols = rep(1, 5), lwd = 2, lty = 1:5, xlab = "Years after baseline", ylim=c(0,1.2),xlim=c(0,12),
 ylab = "", legend.pos = c(4, 1), main= "Women Especific",cex = 0.5)
...
for(i in seq(0, 12, by = 0.5)){
  assign(paste0("pmatrix_t_",i),
         flexsurv::pmatrix.simfs(x = sel_param_fits,
                        t = i,
                        ci = T,
                        B= n_iter/50, #n_iter/50= 200 #24 minutos
                        newdat= newdat3a,
                        trans = mat_3_states),
         envir=.GlobalEnv)
}
