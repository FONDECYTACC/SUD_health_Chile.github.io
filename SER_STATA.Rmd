...
file write myfile `"`r(mean)/365.25'"'
file close myfile
```
...
Summarising by HASHs, the average treatment span between treatments among the readmitted (`r format(as.numeric(readLines('example20.txt')), nsmall=0, digits=0)`) in years is around `r format(as.numeric(readLines('example21.txt')), nsmall=2, digits=2)` years.
