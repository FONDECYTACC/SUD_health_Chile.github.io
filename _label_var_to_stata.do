...
cap label variable embarazo "Embarazo al Ingreso /Pregnant at Admission"
...
cap label variable origen_ingreso "(modificado en origen_ingreso_mod)/"
...
cap label variable menor_60_dias_diff "Menor a 60 días de diferencia con el registro posterior/Menor a 60 days of difference between the next entry"
...
cap label variable motivoegreso_derivacion "Motivo de Egreso= Derivación/Cause of Discharge= Derivación"
