...
cap label variable cnt_mod_dsm_iv_or "Recuento de Valores en Diagnóstico DSM-IV (Excluye en Estudio si hay más de uno)/Count of Values in Psychiatric Diagnoses (DSM-IV)"
cap label variable cnt_mod_cie_10_or "Recuento de Valores en Diagnóstico CIE-10 (Excluye en Estudio si hay más de uno)/Count of Values in Psychiatric Diagnoses (ICD-10)"
...
cap label variable dias_trat_alta_temprana ""
...
cap label variable condicion_ocupacional_corr "Condición Ocupacional Criterio Corregido(f)/Occupational Status Corrected(f)"
cap label variable cat_ocupacional_corr "Categoría Ocupacional Criterio Corregido(f)/Occupational Category Corrected(f)"
