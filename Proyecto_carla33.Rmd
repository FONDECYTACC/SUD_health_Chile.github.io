...
```{r cum_haz12, eval=T, echo=T, paged.print=TRUE, fig.height=15, fig.width=10, fig.cap="Figure 7a. Estimate of Cumulative Hazards, Three States Model", fig.align="center", error=T}
fig_cox_ab22 + theme(legend.position=c(.9,.7))+ ylim(0,1)

if(no_mostrar==1){
ggsave("eso13b.jpg", fig_cox_ab22 + theme(legend.position=c(.9,.7))+ ylim(0,1),width = 10, height = 15, dpi = 300, units= "in")
dev.off()
}
```

```{r cum_haz22, eval=T, echo=T, paged.print=TRUE, fig.height=15, fig.width=10, fig.cap="Figure 7b. Estimate of Cumulative Hazards, Four States Model", fig.align="center", error=T}
fig_cox_cd22+ theme(legend.position=c(.9,.58))

if(no_mostrar==1){
ggsave("eso13b.jpg", fig_cox_cd22+ theme(legend.position=c(.9,.58)),width = 10, height = 15, dpi = 300, units= "in")
dev.off()
}
```
...
```{r transprob_pat2_b, eval=T, echo=T, paged.print=TRUE,  fig.height=10,  fig.width = 12, fig.cap="Figure 8b. Transition Probabilities (and 95% confidence intervals), 2nd patient, Three-states model", fig.align="center", error=T}
...
```{r transprob_pat_b, eval=T, echo=T, paged.print=TRUE, fig.height=10,  fig.width = 12, fig.cap="Figure 9b. Transition Probabilities (and 95% confidence intervals), 1st patient, Three-states model", fig.align="center", error=T}
