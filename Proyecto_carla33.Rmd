...
pmatrix_4s_t_a_df_final %>% 
 ...
 # kableExtra::add_footnote("Note. NA= Null values", notation="none") %>% 
  ...
  kableExtra::pack_rows("At ~122 days/4 months", 13, 16) %>%
  kableExtra::pack_rows("At ~183 days/6 months", 17, 20) %>%
  kableExtra::pack_rows("At ~274days/9 months", 21, 24) %>%
  kableExtra::pack_rows("At ~1 year", 25, 28) %>%
  kableExtra::pack_rows("At ~3 years", 29, 32) %>%
  kableExtra::pack_rows("At ~5 years", 33, 36) %>%
  kableExtra::scroll_box(width = "100%", height = "375px") 
```
