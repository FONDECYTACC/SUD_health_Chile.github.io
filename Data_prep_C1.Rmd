...
```{r echo=F, paged.print=TRUE}
print(summarytools::ctable(CONS_C1_df$embarazo, CONS_C1_df$Sexo, prop = "c",totals = FALSE))
...
```{r echo=F, paged.print=TRUE}
 print(summarytools::ctable(CONS_C1_df$identidad.de.genero, CONS_C1_df$Sexo, prop = "c",totals = FALSE, style="rmarkdown"))
```
<br>
&nbsp;
