...
&nbsp;
<br>
The dataset discarded duplicated rows in almost every variable, excepting the row number in the whole consolidated dataset and the year of the dataset in which the row was obtained. For the purpose of this page, we use the terms "rows" and "cases" as equal to refer to the entries of the dataset.
<br>
...
&nbsp;
<br>
We need to discard cases that may be duplicated or with information overlapped 
<br>
