...
res <- glmulti(abandono_temp ~ compromiso_biopsicosocial + origen_ingreso_mod + dg_cie_10 + dg_trs_fisico, #tal vez  no debería meter esta última variable.
               data=CONS_C1_df_dup_JUL_2020_match_top_sel2,
...
library(lsmeans)
refR_1 <- lsmeans(res@objects[[2]], specs = c("compromiso_biopsicosocial","dg_cie_10"))
ref_dfR_1 <- as.data.frame(cbind(summary(refR_1)[1:2],exp(summary(refR_1)[,c(3,6,7)])))

g4R_1 <- ggplot(ref_dfR_1, aes(x=compromiso_biopsicosocial, y=lsmean,group=dg_cie_10, colour=dg_cie_10))+
