...
Despite both tests indicated significant differences between the levels of biopsychosocial compromise in scores of the TOP, the r-square let us interpret that these differences only explain the `r scales::percent(round(get_adjusted_r2(vegan_1),3))` of the variances of the scores, in such way that levels in the biopsychosocial compromise may not be capable of predicting a determin, affecting the generalizab
...
```{r fig9_int2,eval=T, echo=T, fig.align='center', paged.print=TRUE,fig.cap= "Figure 9. Interactive Effects in the Prob. of Early Drop-out with Diagnose of Physical Diagnosis", eval=T}
library(lsmeans)
