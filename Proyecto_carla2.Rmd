...
Six candidate distributions were considered to model transitions from Adm→Ther.Disch., Adm.→Readm. and Ther.Disch.→Readm., including Weibull (AFT), Gompertz, Log-logistic, Gamma, Generalized gamma, Lognormal, Exponential. 
