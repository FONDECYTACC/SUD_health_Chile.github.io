...
wcomp <- ipwtm(
  ...
  timevar=trans,
  type="first",
  data = subset(ms_d_match_surv_res_tm,id %in% 1:5e5))
wincomp <- ipwtm(
  exposure = tipo_de_plan_res_1,
  family = "binomial",
  link = "logit",
  ...
  timevar=trans,
  type="first",
  data = subset(ms_d_match_surv_res_tm,id %in% 1:5e2))
```

```{r aftgee2,eval=T, echo=T, paged.print=TRUE, error=T}
b_iter=5e0 #primero lo hacemos simple para ver cuÃ¡nto da. Luego corremos el que tenga menor QIC
subs_gee=1:5e5
