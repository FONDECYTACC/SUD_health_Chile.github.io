...
df<-
  ...
  #15. Pararse en n_missing y generar una columna a la izquierda, pegando el siguiente formula: =SI(SI.ERROR(BUSCARV(CONCATENAR(A4,"_",CONTAR.SI($A$4:$A4,A4)-1),para_pegar_cat_factores!F:H,3,0),"")=9999999,"",SI.ERROR(BUSCARV(CONCATENAR(A4,"_",CONTAR.SI($A$4:$A4,A4)-1),para_pegar_cat_factores!F:H,3,0),""))
