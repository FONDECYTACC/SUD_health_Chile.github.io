...
codebook_data <- CONS_C1_df_dup_JUL_2020%>%
    dplyr::mutate(id_centro=factor(id_centro))
...
df<-
  ...
  #8. Añadir Propiedad a la izquierda de Tipos de Datos (Data Type) (insertar a la izquierda)
  ...
  #9. Fijarse que la última variable tenga todas las categorías llenas con Nombre Variable Estandarizado (abajo al fnal)
  ...
  #16. Pararse en n_missing y generar una columna a la izquierda, pegando el siguiente formula: =SI(SI.ERROR(BUSCARV(CONCATENAR(A4,"_",CONTAR.SI($A$4:$A4,A4)-1),para_pegar_cat_factores!F:H,3,0),"")=999,"",SI.ERROR(BUSCARV(CONCATENAR(A4,"_",CONTAR.SI($A$4:$A4,A4)-1),para_pegar_cat_factores!F:H,3,0),""))
  #17. Después pararse en la columna etiquetas (debiese ser la G), y generar una columna a la derecha
  #18. Agregar la siguiente fórmula =SI(I4="",G4,SI.ERROR(BUSCARV(CONCATENAR(A4,"_",CONTAR.SI($A$4:$A4,A4)-1),para_pegar_cat_factores!F:H,2,0),""))
  #19. Introducir file y pegar encabezados debajo de los labels antiguos
  #20. Agregar filtro 
  #21. Eliminar fila 2
