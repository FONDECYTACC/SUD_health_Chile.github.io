...
## 2021-05-06, CENSORED TIME IS NOT THE DIFFERENCE BETWEEN THE TIME OF CENSORSIP AND THE TIME OF THE LAST EVENT, IS THE TOTAL DIFFERENCE. THE SUM OF DAYS UNTIL THE FOLLOWUP TIME
 ...
 dplyr::select(
     ...
     TD_1, TD_2, TD_3, TD_4, DWCA_1, DWCA_2, DWCA_3, DWCA_4, duplicates_filtered) %>%  
  as.data.frame() 
...
for (i in c(2:max(trans_matrix,na.rm=T))){
coxph(Surv(time,status)~factor(tipo_de_plan_res_1)+Tstart,
                  data=subset(ms_d_match_surv_res, trans==i),method = "breslow") %>% 
    assign(paste0("CoxMarkov",i),.,envir=.GlobalEnv)
  round(exp(coef(get(paste0("CoxMarkov",i)))),2)%>% assign(paste0("HR",i),.,envir=.GlobalEnv)
  round(exp(confint(get(paste0("CoxMarkov",i)))),2)%>% assign(paste0("CI",i),.,envir=.GlobalEnv)
...
etm_ms_d_match_surv<-
mstate::msdata2etm(ms_d_match_surv_res, "id", c("tipo_de_plan_res","tipo_de_plan_res_1", "TD_1", "TD_2", "TD_3", "TD_4"))
...
# cox_markov_test_prueba12<-
  ...
  #mstate::MarkovTest(ms_d_match_surv_res_tm[which(ms_d_match_surv_res_tm$id %in% 1:30),], formula="tipo_de_plan_res_1 + TD_1", transition=1, grid=tseq, B=2)
...
cox_markov_test_prueba23<-
  ...
  #mstate::MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res_1 + TD_1", transition=2, grid=tseq, B=200)
...
cox_markov_test_prueba34<-
  ...
  #mstate::MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res_1 + TD_1", transition=3, grid=tseq, B=200)
...
#mstate::MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res_1 + TD_1", transition=4, grid=tseq, B=200)
...
plot.MarkovTest(cox_markov_test_prueba12, tseq, what="states",idx=1:50, 
                ...
                xlab="Days since admission", ylab="Log-rank test statistic", main="Admission to Readmission")

plot_23a_markovt<-
plot.MarkovTest(cox_markov_test_prueba23, tseq, what="states",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Log-rank test statistic", main="Readmission to 2nd Readmission")

plot_34a_markovt<-
plot.MarkovTest(cox_markov_test_prueba34, tseq, what="states",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Log-rank test statistic", main="2nd Readmission to 3rd Readmission")

plot_45a_markovt<-
plot.MarkovTest(cox_markov_test_prueba45, tseq, what="states",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Log-rank test statistic", main="3rd Readmission to 4th Readmission")

plot_12_markovt<-
plot.MarkovTest(cox_markov_test_prueba12, tseq, what="overall",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Chi-square test statistic", main="Admission to Readmission")

plot_23_markovt<-
plot.MarkovTest(cox_markov_test_prueba23, tseq, what="overall",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Chi-square test statistic", main="Readmission to 2nd Readmission")

plot_34_markovt<-
plot.MarkovTest(cox_markov_test_prueba34, tseq, what="overall",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Chi-square test statistic", main="2nd Readmission to 3rd Readmission")

plot_45_markovt<-
plot.MarkovTest(cox_markov_test_prueba45, tseq, what="overall",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Chi-square test statistic", main="3rd Readmission to 4th Readmission")

cowplot::plot_grid(plot_12_markovt, plot_23_markovt, plot_34_markovt, plot_45_markovt)#,labels = c("a", "b", "c","d")
...
plot_12d_markovt<-
plot.MarkovTest(cox_markov_test_prueba12d, tseq, what="overall",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Chi-square test statistic", main="Admission to Readmission")
plot_23d_markovt<-
plot.MarkovTest(cox_markov_test_prueba23d, tseq, what="overall",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Chi-square test statistic", main="Readmission to 2nd Readmission")
plot_34d_markovt<-
plot.MarkovTest(cox_markov_test_prueba34d, tseq, what="overall",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Chi-square test statistic", main="2nd Readmission to 3rd Readmission")
plot_45d_markovt<-
plot.MarkovTest(cox_markov_test_prueba45d, tseq, what="overall",idx=1:50, 
                states=colnames(trans_matrix),
                xlab="Days since admission", ylab="Chi-square test statistic", main="3rd Readmission to 4th Readmission")
#orig_ch_stat= Overall chi-squared summary statistic
#p_stat_wb= P-values corresponding to each of the summary statistics for each starting state
...
cowplot::plot_grid(plot_12d_markovt, plot_23d_markovt, plot_34d_markovt, plot_45d_markovt)#,labels = c("a", "b", "c","d")
...
if (grepl("CISS Fondecyt",rstudioapi::getSourceEditorContext()$path)==T){
    save.image("C:/Users/CISS Fondecyt/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_apr22.RData")
  } else if (grepl("andre",rstudioapi::getSourceEditorContext()$path)==T){
    save.image("C:/Users/andre/Desktop/SUD_CL/mult_state_apr22.RData")
  } else if (grepl("E:",rstudioapi::getSourceEditorContext()$path)==T){
    save.image("E:/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_apr22.RData")
  } else if (grepl("G:",rstudioapi::getSourceEditorContext()$path)==T){
    save.image("G:/Mi unidad/Alvacast/SISTRAT 2019 (github)/mult_state_apr22.RData")
  } else {
    save.image("~/mult_state_apr22.RData")
    path.expand("~/mult_state_apr22.RData")
  }
