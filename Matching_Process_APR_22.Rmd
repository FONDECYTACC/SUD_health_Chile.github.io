...
if (grepl("CISS Fondecyt",path)==T){
    ...
    setwd("G:/Mi unidad/Alvacast/SISTRAT 2019 (github)/SUD_CL/");load("G:/Mi unidad/Alvacast/SISTRAT 2019 (github)/8.Rdata")
  }
...
# cox_markov_test_prueba12<-
  ...
  #MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res_1 + TD_1", transition=1, grid=tseq, B=1000)
...
cox_markov_test_prueba23<-
  ...
  #MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res_1 + TD_1", transition=2, grid=tseq, B=1000)
...
cox_markov_test_prueba34<-
  ...
  #MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res_1 + TD_1", transition=3, grid=tseq, B=1000)
...
#MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res_1 + TD_1", transition=4, grid=tseq, B=1000)
...
#MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res + TD_1 + TD_2", transition=2, grid=tseq, B=1000)
...
#MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res + TD_1 + TD_2+ TD_3", transition=3, grid=tseq, B=1000)

overall_test(cox_markov_test_prueba34d)

cox_markov_test_prueba45d<-
  cox_markov_test(etm_ms_d_match_surv, formula="tipo_de_plan_res + TD_1+ TD_2+ TD_3+ TD_4", tfrom=4, tto=5, grid=tseq, trans=trans_matrix_etm, B=1000)
#MarkovTest(ms_d_match_surv_res_tm, formula="tipo_de_plan_res + TD_1 + TD_2+ TD_3+ TD_4", transition=4, grid=tseq, B=200)
