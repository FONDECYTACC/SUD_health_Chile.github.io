...
CONS_C1_df_dup_SEP_2020_prev2%>% 
    janitor::tabyl(a_botar) %>% 
      knitr::kable(format= "html", format.args= list(decimal.mark= ".", big.mark= ","),
               caption="Table 1. First entries of each user",
...
```{r 3_stset_incidence_rate,eval=T, echo=T, paged.print=TRUE}                                                       
#**STSET
...
Next, we discarded posterior treatments. The total inicidence rate was `r formatC(17764/(sum(CONS_C1_df_dup_SEP_2020_prev3$person_years))*1000,digits=1,format = "f")` readmissions per person-years.
...
survfit_days_new_treat_simple<-survfit(Surv(person_days, event) ~ 1, 
                                data=CONS_C1_df_dup_SEP_2020_prev3)

cuminc<-cmprsk::cuminc(CONS_C1_df_dup_SEP_2020_prev3$person_years, CONS_C1_df_dup_SEP_2020_prev3$event)

#summary(cuminc$`1 1`$time)
