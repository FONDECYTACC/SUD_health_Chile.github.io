...
#Corrección número de diagnósticos cie-10
  #_#_#_#_#_#_#_#_#_#_#_
...
#_#_#_#_#_#_#_#_#_#_#_
  #sumrows de los diagnósticos, excluyendo a "instudy" dg_fis_in_study
...
To describe the incidence rate of SUD treatment readmissions by type of health conditions
...
CONS_C1_df_dup_SEP_2020 %>% 
    ...
    #%>% janitor::tabyl(event)
      ...
      dplyr::mutate(cnt_mod_cie_10_or_irr=dplyr::case_when(cnt_mod_cie_10_or==0 & dg_cie_10_rec!="Diagnosis unknown (under study)"~0,
                                                           ...
                                                           TRUE~NA_real_)) %>% 
      dplyr::mutate(cnt_mod_cie_10_or_in_study_irr=dplyr::case_when(dg_cie_10_rec=="Diagnosis unknown (under study)"~1,
                                                                    dg_cie_10_rec=="Without psychiatric comorbidity"~0,
                                                                    TRUE~NA_real_)) %>% 
