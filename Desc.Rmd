...
CONS_C1_df_dup_SEP_2020_prev4_explore$motivodeegreso_mod_imp <- factor(CONS_C1_df_dup_SEP_2020_prev4_explore$motivodeegreso_mod_imp,labels=c('Late Drop-out',
  ...
  #:#:#:#:#:#:#:#:#:#:#:#:#:#:#:#:#:#:#:#:#:#:#:#:  
  #frequency of consumption
CONS_C1_df_dup_SEP_2020_prev4_explore$freq_cons_sus_prin <- factor(CONS_C1_df_dup_SEP_2020_prev4_explore$freq_cons_sus_prin,labels=c("1 day a week or less",
                                                                                  "2 to 3 days a week",
                                                                                  "4 to 6 days a week",
                                                                                  "Less than 1 day a week",
                                                                                  "Did not use",
