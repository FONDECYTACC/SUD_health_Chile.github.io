...
```{r explore inconsistencies, message=F, error=T,eval=T, warnings=F, echo=T}
# To fold source code, add this before:
# <div class="fold s">
# 
# To fold output, add this before:
# <div class="fold o">
errores_edad<-
...
knitr::kable(format="html",caption= "Table. Summary of Dates") %>% 
    kableExtra::kable_classic(bootstrap_options = c("striped", "hover","condensed"),font_size= 10)
```
