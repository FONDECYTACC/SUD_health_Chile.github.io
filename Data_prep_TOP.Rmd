...
```
<br>
Considering the abovementioned observation, we changed those cases with Masculine identitiy (obtained from C1 dataset) into a general population  (PR) plan.
<br>
...
CONS_TOP_df_dup_ENE_2020_prev7 %>%
    ...
    dplyr::mutate(tipo_de_plan=ifelse(identidad.de.genero=="Masculino" & tipo_de_plan=="M-PAI","PG-PAI", tipo_de_plan)) %>%
    dplyr::mutate(tipo_de_plan=ifelse(identidad.de.genero=="Masculino" & tipo_de_plan=="M-PR","PG-PR", tipo_de_plan)) %>% 
    #PARA VER LO QUE PASA
...
codebook::var_label(CONS_TOP_df_dup_ENE_2020_prev9) <- list(HASH_KEY = 'Codificación del RUT/Masked Identifier (RUT)',
    ...
    Fecha.Aplicación.TOP = 'Fecha de Aplicación del TOP/Date of TOP Application',
    ...
    Sexo = 'Sexo/Sex',
    Fecha.de.Ingreso.a.Tratamiento = 'Fecha de Ingreso a Tratamiento/ Date of Admission to Treatment',
    ...
    Sustancia.Principal.1 = 'Sustancia Principal de Consumo (1)/Main Substance of Consumption (1)',
    Sustancia.Principal.2 = 'Sustancia Principal de Consumo (2)/Main Substance of Consumption (2)',
    Sustancia.Principal.3 = 'Sustancia Principal de Consumo (3)/Main Substance of Consumption (3)',
