...
### 4. Deletion of nearly exact duplicated cases

nbsp;
<br>
We need reduce the number of cases, but in the mean time, try to reduce the loss of information due to specific changes in each entry, despite it could be originated by different mechanisms (eg. different persons may evaluated  ), other than comming from the same yearly dataset. 
