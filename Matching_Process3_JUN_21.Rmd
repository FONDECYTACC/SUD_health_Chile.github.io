...
cumhaz_data_a_1096 <- rbind(data.frame(msf1$Haz[msf1$Haz$time<=1827,],
                                model = "NP Cox"),
...
cumhaz_data_a_1096$trans <- factor(cumhaz_data_a_1096$trans,
                            levels = seq(1, 4),
                            labels = trans_lab_four_st$paste)
cumhaz_data_b_1096 <- rbind(data.frame(msf0$Haz[msf0$Haz$time<=1827,],
                                model = "NP Cox"),
                      data.frame(cox_cumhaz_b$Haz,
                                model = "Cox"),
                      data.frame(flexsurv_cumhaz_b$Haz,
...
if(no_mostrar==1){
jpeg(paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","_mult_state_ags/",path),"cum_haz_pat1.jpg"), height=30, width= 10, res= 600, units = "in")
fig_diff_mod_ab
  dev.off()
jpeg(paste0(gsub("SUD_CL/Matching_Process_JUN_21.Rmd","_mult_state_ags/",path),"cum_haz_pat1_1096.jpg"), height=30, width= 10, res= 600, units = "in")
fig_diff_mod_ab_1096
  dev.off()
}
```
